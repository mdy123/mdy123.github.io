  ...
  */
    ...
    projects.display = function() {
        ...
        for (var projectIndex in projects.projects) {
            ...
            for (var imgIndex in projects.projects[projectIndex].images) {
            ...
            for (var arrIndex in projectArray) {
    ...
    education.displaySchool = function() {
        ...
        for (var schoolIndex in education.schools) {
            ...
            for (var arrIndex in schoolArray) {
    ...
    education.displayonlineCourse = function() {
        ...
        for (var onlineCourseIndex in education.onlineCourses) {
            onlineCourseArray = [
            ...
            for (var arrIndex in onlineCourseArray) {
    ...
    for (var arrIndex in footerContactArray) {
