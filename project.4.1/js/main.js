...
var pizzaElementGenerator = function(i) {
  ...
  pizzaContainer.id = "pizza" + i;                // gives each pizza element a unique id VarID
  ...
  pizzaName.innerHTML = randomName();       // varPizzaName
  pizzaDescriptionContainer.appendChild(pizzaName);

  ul = document.createElement("ul");
  ul.innerHTML = makeRandomPizza();     //    varLI
  //console.log(makeRandomPizza());
  pizzaDescriptionContainer.appendChild(ul);
  pizzaContainer.appendChild(pizzaDescriptionContainer);
  
 htmlStr= '<div class="randomPizzaContainer" id="pizza' + i +'" style="width: 33.33%; height: 325px;"><div class="col-md-6"><img src="images/pizza.webp" class="img-responsive"></div><div class="col-md-6"><h4>' + randomName() + '</h4><ul>' + makeRandomPizza() + '</ul></div></div>';
 console.log(htmlStr);
...
/*
htmlStr = htmlStr + '<div id="pizza0" class="randomPizzaContainer" style="width:33.33%;"><div class="col-md-6"><img src="images/pizza.webp" class="img-responsive"></div><div class="col-md-6"><h4>The Udacity Special</h4><ul><li>Turkey</li><li>Tofu</li><li>Cauliflower</li><li>Sun Dried Tomatoes</li><li>Velveeta Cheese</li><li>Red Sauce</li><li>Whole Wheat Crust</li></ul></div></div> ';
 htmlStr = htmlStr + '<div id="pizza1" class="randomPizzaContainer" style="width:33.33%;"><div class="col-md-6"><img src="images/pizza.webp" class="img-responsive"></div><div class="col-md-6"><h4>The Cameron Special</h4><ul><li>Chicken</li><li>Hot Sauce</li><li>White Crust</li></ul></div></div>';
*/

htmlStr = htmlStr + '<div id="pizza0" class="randomPizzaContainer" style="height: 325px;"><div class="col-md-6"><img src="images/pizza.webp" class="img-responsive"></div><div class="col-md-6"><h4>The Udacity Special</h4><ul><li>Turkey</li><li>Tofu</li><li>Cauliflower</li><li>Sun Dried Tomatoes</li><li>Velveeta Cheese</li><li>Red Sauce</li><li>Whole Wheat Crust</li></ul></div></div> ';
 htmlStr = htmlStr + '<div id="pizza1" class="randomPizzaContainer" style="height: 325px;"><div class="col-md-6"><img src="images/pizza.webp" class="img-responsive"></div><div class="col-md-6"><h4>The Cameron Special</h4><ul><li>Chicken</li><li>Hot Sauce</li><li>White Crust</li></ul></div></div>';
 
for (var i = 2; i < 100; i++) {
  //var pizzasDiv = document.getElementById("randomPizzas");
      
       //pizzasDiv.appendChild(pizzaElementGenerator(i));
 htmlStr= htmlStr +'<div class="randomPizzaContainer" id="pizza' + i +'" style="height: 325px;"><div class="col-md-6"><img src="images/pizza.webp" class="img-responsive"></div><div class="col-md-6"><h4>' + randomName() + '</h4><ul>' + makeRandomPizza() + '</ul></div></div>';       
/*       
  htmlStr= htmlStr +'<div class="randomPizzaContainer" id="pizza' + i +'" style="width: 33.33%; height: 325px;"><div class="col-md-6"><img src="images/pizza.webp" class="img-responsive"></div><div class="col-md-6"><h4>' + randomName() + '</h4><ul>' + makeRandomPizza() + '</ul></div></div>';
 //console.log(htmlStr);
*/ 
}
...
function updatePositions() {
  //var moveElemTemplate = '<img class="mover" ;="" src="images/pizza.webp" style="width: 73.33px; height: 100px; top: 0px; left:' + varLeft +';">'
  frame++;
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    //items[i].style.left = basicLeft[i] + 100 * phase + 'px';
    elem = elem +'<img class="mover" ;="" src="images/pizza.webp" style="width: 73.33px; height: 100px; top:' + moveTop[i] + '; left:' + (basicLeft[i] + 100 * phase + 'px') +';">'
    
  }
  //console.log (document.querySelector("#movingPizzas1"));
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 100; i++) {
    ...
    moveTop.push((Math.floor(i / cols) * s)+ 'px');
    elem=elem + elemTemplate.replace('sTop',((Math.floor(i / cols) * s)+ 'px'));
    //elem=elem + (elemTemplate.replace('"bLeft"',((i % cols) * s) )).replace('sTop',((Math.floor(i / cols) * s)+ 'px'));
  }
   // console.log (elem);
