...
var resizePizzas = function(size) {
    ...
    // ***** I modify css width of class name 'randomPizzaContainer' directly instead of changing individually. ******
...
// ***** I used string for all the pizza type for page loading performance. *****
var htmlStr = '';
...
function updatePositions() {
    ...
    // ******  i move  unessential items out of the loop.         ****** 
    // ******  just change the margin left to make the movement.  *****
...
// ***** margin left to be used by moving pizza funtion. *****
var basicLeft = []; 
document.addEventListener('DOMContentLoaded', function() {
    var cols = 8;
    var s = 256;
    // *****  string template to be modified and used as inner html text after the loop.  *****
    ...
    // ******  i lower the moving pizza count to 35   *****
    for (var i = 0; i < 35; i++) {
